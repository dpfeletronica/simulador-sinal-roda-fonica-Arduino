...
int menu=0, fase1i=0 ,fase1f=0, fase2i=0,fase2f=0,fase3i=0, fase3f=0, fase4i=0, fase4f=0,fase5i=0, fase5f=0, teclacont=0;
...
////4 sinal
if(fase5i>0){
if(contfase==fase5i){//dente inicio
 digitalWrite(12, HIGH);  
}
if(contfase==fase5f){// dente fina
 digitalWrite(12, LOW);  
}}///////////////////////////fim sinal fase*/
}
 }
...
EEPROM.write(10,fase5i );
EEPROM.write(11,fase5f );
 }///////////////////////////
 }////reseta programa
